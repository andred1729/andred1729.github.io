...
Our applications were sevaral, including a self-opening box, restaurant call button, lockers, microhpone, lock-box

Some of the applications can be seen here:

<!-- <div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/box.png" title="example process" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Here is the lock box drying.
</div> -->
...
<div class="caption">
    Demonstration of the self-opening lock box powered by touch.
</div> -->
